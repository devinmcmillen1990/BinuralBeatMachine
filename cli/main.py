...
from beats.generator import generate_monotone_section, generate_polytonal_section
...
def main():
    ...
    parser.add_argument("--style", choices=["monotonal", "polytonal"], default="monotonal", help="Beat generation style (default: monotonal)")
